...
@section('content')
            ...
            <div class="row mb-30-none justify-content-center pt-50">
                <div class="col-lg-4">
                    <img src="{{ asset('data/eiphyu.jpg') }}" alt="teacher"
                        style="width: 270px; height: 350px;; background-size:cover;">
                    <h5 class=""
                        style="font-size: 14px; text-align: center; background-color: #F7931E; color: black; padding: 10px; padding-top: 10px;width:270px;">
    ...
    <section class="section-feature pt-50" style="background-color: white; padding: 0px;" hidden>
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 text-center">
                    <div class="section-round-title">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2 text-center">
                    <div class="section-round-title">
                        <center>
                            <p style="font-size: 14px; color: black; text-align: justify;">
