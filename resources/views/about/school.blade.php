...
@section('content')
                        ...
                        <div class="col-md-6 mb-4 ">
                            <div class="img-overly">
                                <img src="{{ asset('data/class_room/3.jpg') }}" alt=""
                                    style="width: 100%; height: auto; background-size: center; object-fit: contain; border: 4px solid gold; padding: 5px; border-radius: 15px 30px;">
                            </div>
                        </div>
                            ...
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <img class="default-img" src="{{ asset('data/class_room/9.jpg') }}" alt=""
    ...
    <section class="section-feature" style="padding: 20px 0;">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2 text-center">
                    <div class="section-round-title">
    ...
    <section class="products-area py-3">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2 text-center">
                    <div class="section-round-title">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <img class="default-img" src="{{ asset('data/class_room/9.jpg') }}"
                                            alt=""
                                            style="width: 100%; height: 200px; background-size: center; object-fit: cover;">
                                    </div>
                                </div>
